...
update_xml_values "hadoop.http.staticuser.user" "${USER_NAME}" "${HADOOP_CONF_DIR}/core-site.xml"
...
update_xml_values "dfs.namenode.name.dir" "\/home\/${USER_NAME}\/hdfs-data\/nameNode" "${HADOOP_CONF_DIR}/hdfs-site.xml"
update_xml_values "dfs.datanode.data.dir" "\/home\/${USER_NAME}\/hdfs-data\/dataNode" "${HADOOP_CONF_DIR}/hdfs-site.xml"
...
update_spark_defaults "spark.sql.warehouse.dir" "hdfs://${MASTER_HOSTNAME}:9000/user/${USER_NAME}/spark-warehouse" 
